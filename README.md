...
Use **Configure game modes and maps** in the page to edit the available choices. Each list accepts one value per line and is saved in that browser. A selected gamemode or map cannot appear again until at least 50% of its alternatives have appeared.
